...
#define v1190_map_almostfull     v1X90_map_almostfull
#define v1290_map_almostfull     v1X90_map_almostfull
...
/* For V560N */
#define V560_COUNTER_0        0x10 //other channels can be accessed by +0x4
#define V560_SCA_CLE          0x50
